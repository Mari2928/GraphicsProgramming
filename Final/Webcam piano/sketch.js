...
// ********************************
var video;
var prevImg; // Step1: rename the backImg to prevImg 
var diffImg;
var currImg;
var thresholdSlider;
var threshold;
var grid;   // Step3: create a global variable
...
function draw() {
    ...
    // Step5: scale currImg down to a quarter of the size it was
    currImg.resize(currImg.width / 4, currImg.height / 4);
    
    // Step4: run the blur filter on the currImg with 3 iterations
    currImg.filter(BLUR, 3);
    
    diffImg = createImage(video.width, video.height);
    
    // Step5: scale diffImg down to a quarter of the size it was
